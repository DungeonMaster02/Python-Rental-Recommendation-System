...
def ensure_frontend_build() -> str:
    ...
    The frontend source code lives in code/frontend.
    The production build should exist in code/frontend/dist.
...
def register_api_routes(app: Flask) -> None:
    ...
    def api_model_metrics() -> Any:
        """Return model evaluation metrics from output/safety_folds_results.csv."""
        try:
...
def load_grid_geometry_by_id() -> dict[int, dict[str, Any]]:
    ...
    """
    shp_path = project_paths()["data"] / "City_Boundary" / "LA_400m_grid.shp"
...
def fetch_model_metrics() -> dict[str, Any]:
    """Read model metrics from output/safety_folds_results.csv."""
