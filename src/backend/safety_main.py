...
from data_processing import to_score
...
if __name__ == "__main__":
    ...
    future_monthly.to_csv(output_dir / "future_monthly_predictions_2025_2026.csv", index=False)

    final_grid_safety = build_grid_safety_2026(future_monthly)
    final_grid_safety.to_csv(output_dir / "final_grid_safety_2026.csv", index=False)

    save_grid_safety_to_db(final_grid_safety)
    print("2026 grid safety prediction finished and saved to database.")
